...
public class RedisScheduleController {
	...
	public ResponseEntity<? extends BaseResponseBody> save(RedisScheduleCreateReq redisScheduleInfo) {
	...
	public ResponseEntity<? extends BaseResponseBody> delete(RedisScheduleDeleteReq redisScheduleDeleteReq) {
	...
	public ResponseEntity<? extends BaseResponseBody> update(RedisScheduleUpdateReq redisScheduleUpdateReq) {
